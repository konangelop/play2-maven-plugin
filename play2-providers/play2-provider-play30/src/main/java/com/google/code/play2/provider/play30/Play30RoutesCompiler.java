...
public class Play30RoutesCompiler
    implements Play2RoutesCompiler
{
    ...
    private static final String[] supportedGenerators = new String[] { "injected" };
        ...
        throws RoutesCompilationException
    {
        ...
        Seq<String> additionalImportsSeq = CollectionConverters.asScala( additionalImports ).toSeq();
        RoutesCompiler.RoutesCompilerTask routesCompilerTask =
            new RoutesCompiler.RoutesCompilerTask( routesFile, additionalImportsSeq,
                                                   true, true, false );
