...
public class Play30TemplateCompiler
    implements Play2TemplateCompiler
{
    ...
    private static final List<String> defaultImportsScala3 = Arrays.asList(
    ...
    {
        List<String> defaultImports = new ArrayList<String>( defaultImportsScala3.size() + defaultPlayImportsJava.size() );
        defaultImports.addAll( defaultImportsScala3 );
    ...
    {
        List<String> defaultImports = new ArrayList<String>( defaultImportsScala3.size() + defaultPlayImportsScala.size() );
        defaultImports.addAll( defaultImportsScala3 );
